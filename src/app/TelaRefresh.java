...
/**
 * TelaRefresh
 *  Responsavel em ficar escrevendo na tela
 *  Lendo o vetor de barcos e setando
 */
public class TelaRefresh {
    ...
    public void testeDeTela(){
        ...
        System.out.println(ANSI_BLUE_BACKGROUND + ANSI_BLACK + "       " + ANSI_RESET+ANSI_PURPLE_BACKGROUND+ ANSI_BLACK + "X" + ANSI_RESET+ANSI_BLUE_BACKGROUND + ANSI_BLACK + "  " + ANSI_RESET);
        ...
        System.out.println(ANSI_BLUE_BACKGROUND + ANSI_BLACK + "          " + ANSI_RESET);
        System.out.println(ANSI_BLUE_BACKGROUND + ANSI_BLACK + "          " + ANSI_RESET);
        System.out.println(ANSI_BLUE_BACKGROUND + ANSI_BLACK + "        " + ANSI_RESET+ANSI_RED_BACKGROUND + ANSI_BLACK + "DD" + ANSI_RESET);
        System.out.println(ANSI_BLUE_BACKGROUND + ANSI_BLACK + "          " + ANSI_RESET);
    }
